        ...
        <link href="{{asset('assets/back/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{asset('assets/back/css/layout.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('assets/back/css/darkblue.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
        <link href="{{asset('assets/back/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
        
        {{-- <link href="{{asset('assets/back/fonts/Simple-Line-Icons.woff')}}" rel="stylesheet" type="text/css" /> --}}
